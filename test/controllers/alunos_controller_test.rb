...
class AlunosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aluno" do
    assert_difference("Aluno.count") do
      post alunos_url, params: { aluno: { casa_id: @aluno.casa_id, nome: @aluno.nome, turma: @aluno.turma } }
    end
  ...
  test "should update aluno" do
    patch aluno_url(@aluno), params: { aluno: { casa_id: @aluno.casa_id, nome: @aluno.nome, turma: @aluno.turma } }
