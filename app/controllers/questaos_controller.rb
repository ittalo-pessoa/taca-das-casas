class QuestaosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @questao.save
        format.html { redirect_to questaos_path, notice: "Questao was successfully created." }
  ...
  private
    ...
    def questao_params
      params.require(:questao).permit(:enunciado, :pontuacao, alternativas: [], categorias: [])
    end
end
